...
class BurpExtender(IBurpExtender, IScannerCheck,
    ...
    def _create_ui(self):
        ...
        self._main_jtabedpane.addTab("Global & Active Scanning configuration", None, None, None)
        ...
        self._main_jtabedpane.addTab("About", None, None, None)
...
class ScanController(JSplitPane, IMessageEditorController, DocumentListener):
    ...
    def _create_ui(self):
        ...
        self.setLeftComponent(self.button_panel)
